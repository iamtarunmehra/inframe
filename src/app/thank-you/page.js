...
export default function ThankYouRegistration() {
    ...
    return (
        <div className="min-h-auto flex items-center justify-center bg-white lg:px-6 lg:py-12 mb-10">
            <div style={{ background: 'linear-gradient(154deg,rgba(182, 189, 0, 1) 0%, rgba(255, 248, 189, 1) 50%, rgba(255, 229, 0, 1) 100%)' }} className="max-w-5xl w-full lg:rounded-xl shadow-xl p-12 text-center">
