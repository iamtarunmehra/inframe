    ...
    return (
        <div className='grid lg:grid-cols-3 grid-cols-1 gap-10'>
            {data.map((item, index) => {
                let { points } = item
                return (
                    <div key={index} className='bg-white w-[100%] z-10 group overflow-hidden h-auto my-[40px] hover:shadow-2xl shadow-amber-300 duration-300 rounded-[20px]'>
    ...
    return (
        <div className='grid lg:grid-cols-3 grid-cols-1 gap-10'>
            {data.map((item, index) => {
                let { points } = item
                return (
                    <div key={index} className='bg-white w-[100%] overflow-hidden group h-auto my-[40px] hover:shadow-2xl shadow-amber-300 duration-300 rounded-[20px]'>
    ...
    return (
        <div className='grid lg:grid-cols-3 grid-cols-1 gap-10'>
            {data.map((item, index) => {
                let { points } = item
                return (
                    <div key={index} className='bg-white w-[100%] group overflow-hidden h-auto my-[40px] hover:shadow-2xl shadow-amber-300 duration-300 rounded-[20px]'>
