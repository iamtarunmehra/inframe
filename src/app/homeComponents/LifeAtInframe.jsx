...
export default function LifeAtInframe() {
    ...
    return (
        <div className='max-w-7xl mx-auto p-3 lg:p-0 lg:my-[60px] my-[20px]'>
                    ...
                    data.map((item, index) => {
                        return (
                            <div key={index} style={{ backgroundImage: `url(${item.src})` }}
                                className='w-[100%] relative h-[500px] bg-no-repeat bg-cover flex items-end'
                            >
                                <div className='absolute w-[100%] h-[100%] bg-[rgba(0,0,0,0.5)]'></div>
