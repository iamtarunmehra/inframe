...
export default function Banner() {
    return (
        <div className='max-w-7xl overflow-hidden p-3 lg:p-0 mx-auto lg:my-[60px] my-[20px] lg:gap-y-0 gap-y-10 grid lg:grid-cols-[55%_auto] gap-3 grid-cols-1 justify-between'>
            <div>
                ...
                <button className='lg:w-[330px] w-[100%] py-[15px] rounded-xl bg-amber-400 text-[20px] font-semibold mt-3 cursor-pointer hover:bg-white border-2 border-transparent hover:border-amber-500 duration-300 hover:text-amber-500'>Enroll Now</button>
            </div>
            <div>
