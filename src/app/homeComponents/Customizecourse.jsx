    ...
    return (
        <div className="w-full">
            <div className='max-w-4xl grid sm:grid-cols-2 gap-10  p-3 lg:p-0 mx-auto lg:my-[80px] my-[20px]'>
                <div className='border-[1px] border-gray-300 rounded-[20px] px-5 py-8 shadow-lg'>
                    <div className='flex justify-between '>
                        <h3 className='text-[25px] font-semibold'>Customized course Pack</h3>
                ...
                <div className='border-[1px] border-gray-300 rounded-[20px] px-5 py-8 shadow-lg'>
                    <div className='flex justify-between '>
                        <h3 className='text-[25px] font-semibold'>All Access course Pack</h3>
                        <button className="px-5 py-2 bg-yellow-100 text-amber-600 border border-yellow-400 rounded-full text-sm font-medium">
                            Popular
                        </button>
                    </div>
